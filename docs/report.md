...
Solana state report · generated 2026-09-11 19:59 UTC · run #123 · baseline active

## What needs your attention

- 🟠 **Delinquent stake spiked to 0%, 2.5 standard deviations above its recent norm of 0%.**
  - evidence: baseline n=122, mean=0.1, current=0.4, z=+2.53

## Network

The chain looks healthy: 4,241 TPS (2,132 non-vote) at 319.1 ms per slot, epoch 1032 is 96.79% done.

| metric | value |
|---|---|
| Health | ok |
| Slot | 446,242,146 |
| Block height | 424,285,188 |
| Epoch | 1032 (96.79% complete) |
| TPS (all / non-vote) | 4,241.2 / 2,131.5 |
| Slot time | 319.1 ms |
| Node version | 4.3.0-rc.0 |

## Validators

677 validators are voting, 13 are delinquent (0.41% of stake, nothing alarming). It takes 18 validators to control a third of stake.
...
A quiet day: SOL at $101.94 (+2.2% 24h), $5.88B locked, $2.92B traded on DEXs.

| metric | value |
|---|---|
| SOL price | $101.94 (+2.2% 24h) |
| Market cap | $59.79B |
| TVL | $5.88B |
...
| metric | value |
|---|---|
| Circulating | 586,537,149 SOL |
| Non-circulating | 47,292,565 SOL |
| Total | 633,829,714 SOL |

## Ecosystem

Cluster status: All Systems Operational.

Daily active wallets: 2,354,315 (2026-09-10, via Dune).

Recent agave client releases:

- v4.3.0-rc.1 (pre-release) · 2026-09-11
